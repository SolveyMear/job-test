...
--
-- Host: localhost:3306
-- Generation Time: May 02, 2024 at 09:27 AM
...
CREATE TABLE `job` (
    `id` int NOT NULL, `position` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL, `contract` tinyint(1) NOT NULL, `location` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL, `description` longtext COLLATE utf8mb4_unicode_ci NOT NULL, `requirement_content` longtext COLLATE utf8mb4_unicode_ci, `requirements` json DEFAULT NULL, `role_content` longtext COLLATE utf8mb4_unicode_ci, `roles` json DEFAULT NULL, `created_at` datetime NOT NULL, `apply` longtext COLLATE utf8mb4_unicode_ci NOT NULL, `user_id` int NOT NULL
...
INSERT INTO
    `job` (
        `id`, `position`, `contract`, `location`, `description`, `requirement_content`, `requirements`, `role_content`, `roles`, `created_at`, `apply`, `user_id`
    )
VALUES (
